...
echo '<hr><br>';
echo '<h1><li>'.$a[9].'</li></h1>';
highlight_file($dir.$a[9]);

echo '<hr><br>';
echo '<h1><li>'.$a[10].'</li></h1>';
highlight_file($dir.$a[10]);

echo '<hr><br>';
echo '<h1><li>'.$a[11].'</li></h1>';
highlight_file($dir.$a[11]);
          
echo '<hr><br>';
echo '<h1><li>'.$a[12].'</li></h1>';
highlight_file($dir.$a[12]);
                                                                                                               
echo '<hr><br>';
echo '<h1><li>'.$a[13].'</li></h1>';
highlight_file($dir.$a[13]);
